        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThLevel = table.Column<int>(type: "int", nullable: false),
                    Builders = table.Column<int>(type: "int", nullable: false),
                    BhLevel = table.Column<int>(type: "int", nullable: false),
                    BbBuilders = table.Column<int>(type: "int", nullable: false),
                    GoldPass = table.Column<int>(type: "int", nullable: false),
                    PlanWindowJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InventoryJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HelperLevelsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedAt = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accounts", x => new { x.UserId, x.Id });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Imported = table.Column<bool>(type: "bit", nullable: true),
                    HelpersAppliedJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAt = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
